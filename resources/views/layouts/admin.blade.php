...
<head>
    ...
    <link rel="icon" href="{!! asset('img/fav_kpi.ico') !!}"/>
    @yield('styles')
</head>
...
<body class="sidebar-mini skin-purple" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header">
            <a href="#" class="logo">
                ...
                <span class="logo-lg">{{ trans('panel.site_title_lg') }}</span>
            </a>
                                    ...
                                    <li>
                                        <ul class="menu">
                                            @foreach(config('panel.available_languages') as $langLocale => $langName)
                                                <li>
                                                    <a href="{{ url()->current() }}?change_language={{ $langLocale }}">{{ strtoupper($langLocale) }} </a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{route('admin.profiles.index')}}" class="btn btn-primary btn-flat">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a class="btn btn-danger btn-flat btn-logout" id="tombol">  {{ trans('global.logout') }}</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
        ...
        <footer class="main-footer text-center">
            <strong>{{ trans('panel.site_title') }} &copy;</strong> {{ Carbon\Carbon::now()->format('Y')}}
        </footer>
    ...
    <script src="https://cdn.datatables.net/plug-ins/1.10.22/sorting/absolute.js"></script>
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    $(".notifications-menu").on('click', function () {
        if (!$(this).hasClass('open')) {
            ...
            $.get('/irms/incident-reports/read');
        }
    });
});
    </script>
