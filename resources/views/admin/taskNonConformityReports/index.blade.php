                                ...
                                <tbody>
                                    @foreach ($nonConformityReports as $key => $nonConformityReport)
                                        <tr data-entry-id="{{ $nonConformityReport->id }}">
                                            ...
                                            <td>
                                                @can('task_nonconformity_report_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('admin.task-nonconformity-reports.show', $nonConformityReport->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                    ...
                                                    @can('task_nonconformity_report_edit')
                                                        @if (
                                                            $nonConformityReport->result->id === 4 ||
                                                                ...
                                                                $nonConformityReport->result->id === 8 || $nonConformityReport->result->id === 9)
                                                            <a class="btn btn-xs btn-info"
                                                                href="{{ route('admin.task-nonconformity-reports.edit', $nonConformityReport->id) }}">
                                                                {{ trans('global.edit') }}
                                                            </a>
                                                ...
                                                @can('task_nonconformity_report_delete')
                                                    <form
                                                        action="{{ route('admin.task-nonconformity-reports.destroy', $nonConformityReport->id) }}"
                                                        method="POST"
