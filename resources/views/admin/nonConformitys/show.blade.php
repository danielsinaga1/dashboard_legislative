...
@section('content')
    <div class="content">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        {{ trans('global.show') }} {{ trans('cruds.nonConformityReport.title') }}
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            {{ trans('cruds.nonConformityReport.fields.file_initiator') }}
                                        </th>
                                        <td>
                                            @foreach ($nonConformity->file as $key => $media)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $nonConformity->assigned_to->name ?? '' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            ...
                                            @elseif($nonConformity->result->id === 7)
                                                <span class="label label-default">
                                                    {{ $nonConformity->result->name ?? '' }}
                                                </span>
                                            @elseif($nonConformity->result->id === 8)
                                                <span class="label label-danger">
                                                    {{ $nonConformity->result->name ?? '' }}
                                                </span>
                                                @elseif($nonConformity->result->id === 9)
                                                <span class="label label-danger">
                                                    {{ $nonConformity->result->name ?? '' }}
                                                </span>
                                            @endif
                            ...
                            @if (auth()->user()->is_administrator2 && $nonConformity->assigned_to_id != null && $nonConformity->result_id != 2)
                                <div class="panel-footer">
                                    {{-- @if ($nonConformity->reviewed_by_id !== auth()->user()->id && $nonConformity->result_id == 2 && $nonConformity->status == 'Open') --}}
                                    <a href="{{ route('admin.nonconformity-reports.approvalByAdministrator', $nonConformity->id) }}"
                                    ...
                                    <a href="#" class="btn btn-danger" data-toggle="modal" data-placement="top"
                                        ...
                                        id="rejectBtn" data-myreason="{{ $nonConformity->reason }}">Reject
                                    </a>
                                    @include('partials.modals_non_conformity_reports_rejected_administrator')
                            ...
                            @if (auth()->user()->is_administrator2 && $nonConformity->result_id == 2)
                                <div class="panel-footer">
                                    ...
                                    @include('partials.modals_non_conformity_reports_rejected_administrator_verification')
        ...
        @if ($nonConformity->result_id == 7 || $nonConformity->result_id == 8 || $nonConformity->result_id == 3 || $nonConformity->result_id == 9)
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                                        ...
                                        <tr data-entry-id="{{ $comment_nonconformity->id }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif($comment_nonconformity->result->id === 8)
                                                    ...
                                                    @elseif($comment_nonconformity->result->id === 9)
                                                    <span class="label label-danger">
                                                        {{ $comment_nonconformity->result->name ?? '' }}
                                                    </span>
                                                @endif
