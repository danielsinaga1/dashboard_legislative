...
class NonConformityActionExecutor extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage
            ...
            ->line('Recommendation' . ' ' . ':' . ' ' . $this->nonConformity->description)
            ...
            ->action('View Non Conformity Report', 'http://192.168.12.23/kpi_irms/public/irms/nonconformity-reports/' . $this->nonConformity->id . '/edit');
    }
