...
class NonConformityVerificationAdministrator extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage
            ->subject('Request' . ' ' . 'Non Conformity Report' . ' ' . $this->nonConformity->no_laporan . ' ' . 'Verification' . ' ' . 'for' . ' ' . $this->username)
            ->greeting('Dear ' . $this->username . ',')
            ->line('A new request has been created waiting for your verification.')
            ...
            // }
            ->line('Please check on NCR Application for your verification');
