...
class NonConformityApprovalManagerExecutor extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage
            ->subject('Request' . ' ' . 'Non Conformity Report' . ' ' . $this->nonConformity->no_laporan . ' ' . 'Approval' . ' ' . 'for' . ' ' . $this->username)
