...
class ReminderManagerExecutor extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject('[REMINDER]'.' '.'Request'.' '.'Incident Report'.' '.$this->incidentReport->no_laporan.' '.'Needs follow-up'.' '.'for'.' '.$this->username)
